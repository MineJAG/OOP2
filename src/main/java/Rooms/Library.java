...
public class Library extends Sala{
    ...
    public void initializeInventory(){
        ...
        in.addItem(new Clues("Documento perdido", "No documento diz: Este livro é uma maravilha tenciono publica-lo em meu nome. Mas... Victor não pode descobrir sobre isto.\r\n" + "Assinado: Alistair Blackwood"));
